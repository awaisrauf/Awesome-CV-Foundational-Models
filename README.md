...
**Learning Transferable Visual Models From Natural Language Supervision**  2021 <br> Radford, Alec,  Kim, Jong Wook,  Hallacy, Chris,  Ramesh, Aditya,  Goh, Gabriel,  Agarwal, Sandhini,  Sastry, Girish,  Askell, Amanda,  Mishkin, Pamela,  Clark, Jack,  others <br>  [[**Paper Link**]](http://arxiv.org/pdf/2103.00020v1)<details><summary>Read Abstract</summary>State-of-the-art computer vision systems are trained to predict a fixed set
...
**WenLan: Bridging Vision and Language by Large-Scale Multi-Modal Pre-Training**  2021 <br> Huo, Yuqi,  Zhang, Manli,  Liu, Guangzhen,  Lu, Haoyu,  Gao, Yizhao,  Yang, Guoxing,  Wen, Jingyuan,  Zhang, Heng,  Xu, Baogui,  Zheng, Weihao,  others <br>  [[**Paper Link**]](http://arxiv.org/pdf/2103.06561v6)<details><summary>Read Abstract</summary>Multi-modal pre-training models have been intensively explored to bridge
...
**Open-vocabulary Object Detection via Vision and Language Knowledge Distillation**  2021 <br> Gu, Xiuye,  Lin, Tsung-Yi,  Kuo, Weicheng,  Cui, Yin <br>  [[**Paper Link**]](http://arxiv.org/pdf/2104.13921v3)<details><summary>Read Abstract</summary>We aim at advancing open-vocabulary object detection, which detects objects
...
**CLIP2Video: Mastering Video-Text Retrieval via Image CLIP**  2021 <br> Han Fang,  Pengfei Xiong,  Luhui Xu,  Yu Chen <br>  [[**Paper Link**]](http://arxiv.org/pdf/2106.11097v1)<details><summary>Read Abstract</summary>We present CLIP2Video network to transfer the image-language pre-training
...
**AudioCLIP: Extending CLIP to Image, Text and Audio**  2021 <br> Andrey Guzhov,  Federico Raue,  Jörn Hees,  Andreas Dengel <br>  [[**Paper Link**]](http://arxiv.org/pdf/2106.13043v1)<details><summary>Read Abstract</summary>In the past, the rapidly evolving field of sound classification greatly
...
**Multimodal Few-Shot Learning with Frozen Language Models**  2021 <br> Tsimpoukelli, Maria,  Menick, Jacob L,  Cabi, Serkan,  Eslami, SM,  Vinyals, Oriol,  Hill, Felix <br>  [[**Paper Link**]](http://arxiv.org/pdf/2106.13884v2)<details><summary>Read Abstract</summary>When trained at sufficient scale, auto-regressive language models exhibit the
...
**Extract Free Dense Labels from CLIP**  2022 <br> Zhou, Chong,  Loy, Chen Change,  Dai, Bo <br>  [[**Paper Link**]](http://arxiv.org/pdf/2112.01071v2)<details><summary>Read Abstract</summary>Contrastive Language-Image Pre-training (CLIP) has made a remarkable
...
**Image Segmentation Using Text and Image Prompts**  2022 <br> L{\"u}ddecke, Timo,  Ecker, Alexander <br>  [[**Paper Link**]](http://arxiv.org/pdf/2112.10003v2)<details><summary>Read Abstract</summary>Image segmentation is usually addressed by training a model for a fixed set
...
**Scaling Open-Vocabulary Image Segmentation with Image-Level Labels**  2021 <br> Golnaz Ghiasi,  Xiuye Gu,  Yin Cui,  Tsung-Yi Lin <br>  [[**Paper Link**]](http://arxiv.org/pdf/2112.12143v2)<details><summary>Read Abstract</summary>We design an open-vocabulary image segmentation model to organize an image
...
**GroupViT: Semantic Segmentation Emerges from Text Supervision**  2022 <br> Jiarui Xu,  Shalini De Mello,  Sifei Liu,  Wonmin Byeon,  Thomas Breuel,  J. Kautz,  X. Wang <br>  [[**Paper Link**]](http://arxiv.org/pdf/2202.11094v5)<details><summary>Read Abstract</summary>Grouping and recognition are important components of visual scene
...
**Simple Open-Vocabulary Object Detection with Vision Transformers**  2022 <br> Matthias Minderer,  Alexey Gritsenko,  Austin Stone,  Maxim Neumann,  Dirk Weissenborn,  Alexey Dosovitskiy,  Aravindh Mahendran,  Anurag Arnab,  Mostafa Dehghani,  Zhuoran Shen,  Xiao Wang,  Xiaohua Zhai,  Thomas Kipf,  Neil Houlsby <br>  [[**Paper Link**]](http://arxiv.org/pdf/2205.06230v2)<details><summary>Read Abstract</summary>Combining simple architectures with large-scale pre-training has led to
...
**GIT: A Generative Image-to-text Transformer for Vision and Language**  2022 <br> Wang, Jianfeng,  Yang, Zhengyuan,  Hu, Xiaowei,  Li, Linjie,  Lin, Kevin,  Gan, Zhe,  Liu, Zicheng,  Liu, Ce,  Wang, Lijuan <br>  [[**Paper Link**]](http://arxiv.org/pdf/2205.14100v5)<details><summary>Read Abstract</summary>In this paper, we design and train a Generative Image-to-text Transformer,
...
**Language Models are General-Purpose Interfaces**  2022 <br> Yaru Hao,  Haoyu Song,  Li Dong,  Shaohan Huang,  Zewen Chi,  Wenhui Wang,  Shuming Ma,  Furu Wei <br>  [[**Paper Link**]](http://arxiv.org/pdf/2206.06336v1)<details><summary>Read Abstract</summary>Foundation models have received much attention due to their effectiveness
...
**A Unified Sequence Interface for Vision Tasks**  2022 <br> Chen, Ting,  Saxena, Saurabh,  Li, Lala,  Lin, Tsung-Yi,  Fleet, David J,  Hinton, Geoffrey E <br>  [[**Paper Link**]](http://arxiv.org/pdf/2206.07669v2)<details><summary>Read Abstract</summary>While language tasks are naturally expressed in a single, unified, modeling
...
**BridgeTower: Building Bridges Between Encoders in Vision-Language Representation Learning**  2022 <br> Xu, Xiao,  Wu, Chenfei,  Rosenman, Shachar,  Lal, Vasudev,  Duan, Nan <br>  [[**Paper Link**]](http://arxiv.org/pdf/2206.08657v5)<details><summary>Read Abstract</summary>Vision-Language (VL) models with the Two-Tower architecture have dominated
...
**MineDojo: Building Open-Ended Embodied Agents with Internet-Scale Knowledge**  2022 <br> Linxi Fan,  Guanzhi Wang,  Yunfan Jiang,  Ajay Mandlekar,  Yuncong Yang,  Haoyi Zhu,  Andrew Tang,  De-An Huang,  Yuke Zhu,  Anima Anandkumar <br>  [[**Paper Link**]](http://arxiv.org/pdf/2206.08853v2)<details><summary>Read Abstract</summary>Autonomous agents have made great strides in specialist domains like Atari
...
**LM-Nav: Robotic Navigation with Large Pre-Trained Models of Language, Vision, and Action**  2022 <br> Dhruv Shah,  Blazej Osinski,  Brian Ichter,  Sergey Levine <br>  [[**Paper Link**]](http://arxiv.org/pdf/2207.04429v2)<details><summary>Read Abstract</summary>Goal-conditioned policies for robotic navigation can be trained on large,
...
**Masked Vision and Language Modeling for Multi-modal Representation Learning**  2023 <br> Gukyeong Kwon,  Zhaowei Cai,  Avinash Ravichandran,  Erhan Bas,  Rahul Bhotika,  Stefano Soatto <br>  [[**Paper Link**]](http://arxiv.org/pdf/2208.02131v2)<details><summary>Read Abstract</summary>In this paper, we study how to use masked signal modeling in vision and
...
**Images Speak in Images: A Generalist Painter for In-Context Visual Learning**  2023 <br> Wang, Xinlong,  Wang, Wen,  Cao, Yue,  Shen, Chunhua,  Huang, Tiejun <br>  [[**Paper Link**]](http://arxiv.org/pdf/2212.02499v2)<details><summary>Read Abstract</summary>In-context learning, as a new paradigm in NLP, allows the model to rapidly
...
**Reproducible scaling laws for contrastive language-image learning**  2023 <br> Cherti, Mehdi,  Beaumont, Romain,  Wightman, Ross,  Wortsman, Mitchell,  Ilharco, Gabriel,  Gordon, Cade,  Schuhmann, Christoph,  Schmidt, Ludwig,  Jitsev, Jenia <br>  [[**Paper Link**]](http://arxiv.org/pdf/2212.07143v1)<details><summary>Read Abstract</summary>Scaling up neural networks has led to remarkable performance across a wide
...
**Toward Building General Foundation Models for Language, Vision, and Vision-Language Understanding Tasks**  2023 <br> Zhang, Xinsong,  Zeng, Yan,  Zhang, Jipeng,  Li, Hang <br>  [[**Paper Link**]](http://arxiv.org/pdf/2301.05065v1)<details><summary>Read Abstract</summary>Foundation models or pre-trained models have substantially improved the
...
**BLIP-2: Bootstrapping Language-Image Pre-training with Frozen Image Encoders and Large Language Models**  2023 <br> Li, Junnan,  Li, Dongxu,  Savarese, Silvio,  Hoi, Steven <br>  [[**Paper Link**]](http://arxiv.org/pdf/2301.12597v3)<details><summary>Read Abstract</summary>The cost of vision-and-language pre-training has become increasingly
...
**Grounding Language Models to Images for Multimodal Inputs and Outputs**  2023 <br> Koh, Jing Yu,  Salakhutdinov, Ruslan,  Fried, Daniel <br>  [[**Paper Link**]](http://arxiv.org/pdf/2301.13823v4)<details><summary>Read Abstract</summary>We propose an efficient method to ground pretrained text-only language models
...
**Prismer: A Vision-Language Model with An Ensemble of Experts**  2023 <br> Shikun Liu,  Linxi Fan,  Edward Johns,  Zhiding Yu,  Chaowei Xiao,  Anima Anandkumar <br>  [[**Paper Link**]](http://arxiv.org/pdf/2303.02506v2)<details><summary>Read Abstract</summary>Recent vision-language models have shown impressive multi-modal generation
...
**Visual ChatGPT: Talking, Drawing and Editing with Visual Foundation Models**  2023 <br> Chenfei Wu,  Shengming Yin,  Weizhen Qi,  Xiaodong Wang,  Zecheng Tang,  Nan Duan <br>  [[**Paper Link**]](http://arxiv.org/pdf/2303.04671v1)<details><summary>Read Abstract</summary>ChatGPT is attracting a cross-field interest as it provides a language
...
**Grounding DINO: Marrying DINO with Grounded Pre-Training for Open-Set Object Detection**  
 <br> Liu, Shilong,  Zeng, Zhaoyang,  Ren, Tianhe,  Li, Feng,  Zhang, Hao,  Yang, Jie,  Li, Chunyuan,  Yang, Jianwei,  Su, Hang,  Zhu, Jun,  others <br>  [[**Paper Link**]](http://arxiv.org/pdf/2303.05499v4)<details><summary>Read Abstract</summary>In this paper, we present an open-set object detector, called Grounding DINO,
...
will be available at \url{https://github.com/IDEA-Research/GroundingDINO}.</details> 
 
**Task and Motion Planning with Large Language Models for Object Rearrangement**  2023 <br> Yan Ding,  Xiaohan Zhang,  Chris Paxton,  Shiqi Zhang <br>  [[**Paper Link**]](http://arxiv.org/pdf/2303.06247v3)<details><summary>Read Abstract</summary>Multi-object rearrangement is a crucial skill for service robots, and
...
**GPT-4 Technical Report**  2023 <br> OpenAI <br>  [[**Paper Link**]](http://arxiv.org/pdf/2303.08774v3)<details><summary>Read Abstract</summary>We report the development of GPT-4, a large-scale, multimodal model which can
...
**EVA-02: A Visual Representation for Neon Genesis**  2023 <br> Fang, Yuxin,  Sun, Quan,  Wang, Xinggang,  Huang, Tiejun,  Wang, Xinlong,  Cao, Yue <br>  [[**Paper Link**]](http://arxiv.org/pdf/2303.11331v2)<details><summary>Read Abstract</summary>We launch EVA-02, a next-generation Transformer-based visual representation
...
**Detecting Everything in the Open World: Towards Universal Object Detection**  2023 <br> Wang, Zhenyu,  Li, Yali,  Chen, Xi,  Lim, Ser-Nam,  Torralba, Antonio,  Zhao, Hengshuang,  Wang, Shengjin <br>  [[**Paper Link**]](http://arxiv.org/pdf/2303.11749v2)<details><summary>Read Abstract</summary>In this paper, we formally address universal object detection, which aims to
...
**EVA-CLIP: Improved Training Techniques for CLIP at Scale**  2023 <br> Sun, Quan,  Fang, Yuxin,  Wu, Ledell,  Wang, Xinlong,  Cao, Yue <br>  [[**Paper Link**]](http://arxiv.org/pdf/2303.15389v1)<details><summary>Read Abstract</summary>Contrastive language-image pre-training, CLIP for short, has gained
...
**Unmasked Teacher: Towards Training-Efficient Video Foundation Models**  2023 <br> Li, Kunchang,  Wang, Yali,  Li, Yizhuo,  Wang, Yi,  He, Yinan,  Wang, Limin,  Qiao, Yu <br>  [[**Paper Link**]](http://arxiv.org/pdf/2303.16058v1)<details><summary>Read Abstract</summary>Video Foundation Models (VFMs) have received limited exploration due to high
...
**HuggingGPT: Solving AI Tasks with ChatGPT and its Friends in Hugging Face**  2023 <br> Yongliang Shen,  Kaitao Song,  Xu Tan,  Dongsheng Li,  Weiming Lu,  Yueting Zhuang <br>  [[**Paper Link**]](http://arxiv.org/pdf/2303.17580v3)<details><summary>Read Abstract</summary>Solving complicated AI tasks with different domains and modalities is a key
...
**Segment Anything**  2023 <br> Kirillov, Alexander,  Mintun, Eric,  Ravi, Nikhila,  Mao, Hanzi,  Rolland, Chloe,  Gustafson, Laura,  Xiao, Tete,  Whitehead, Spencer,  Berg, Alexander C,  Lo, Wan-Yen,  others <br>  [[**Paper Link**]](http://arxiv.org/pdf/2304.02643v1)<details><summary>Read Abstract</summary>We introduce the Segment Anything (SA) project: a new task, model, and
...
**SegGPT: Segmenting Everything In Context**  2023 <br> Wang, Xinlong,  Zhang, Xiaosong,  Cao, Yue,  Wang, Wen,  Shen, Chunhua,  Huang, Tiejun <br>  [[**Paper Link**]](http://arxiv.org/pdf/2304.03284v1)<details><summary>Read Abstract</summary>We present SegGPT, a generalist model for segmenting everything in context.
...
**ChatGPT Empowered Long-Step Robot Control in Various Environments: A Case Application**  2023 <br> Naoki Wake,  Atsushi Kanehira,  Kazuhiro Sasabuchi,  Jun Takamatsu,  Katsushi Ikeuchi <br>  [[**Paper Link**]](http://arxiv.org/pdf/2304.03893v5)<details><summary>Read Abstract</summary>This paper demonstrates how OpenAI's ChatGPT can be used in a few-shot
...
**Video ChatCaptioner: Towards Enriched Spatiotemporal Descriptions**  2023 <br> Jun Chen,  Deyao Zhu,  Kilichbek Haydarov,  Xiang Li,  Mohamed Elhoseiny <br>  [[**Paper Link**]](http://arxiv.org/pdf/2304.04227v3)<details><summary>Read Abstract</summary>Video captioning aims to convey dynamic scenes from videos using natural
...
**OpenAGI: When LLM Meets Domain Experts**  2023 <br> Yingqiang Ge,  Wenyue Hua,  Kai Mei,  Jianchao Ji,  Juntao Tan,  Shuyuan Xu,  Zelong Li,  Yongfeng Zhang <br>  [[**Paper Link**]](http://arxiv.org/pdf/2304.04370v4)<details><summary>Read Abstract</summary>Human intelligence excels at combining basic skills to solve complex tasks.
...
**Graph-ToolFormer: To Empower LLMs with Graph Reasoning Ability via Prompt Augmented by ChatGPT**  2023 <br> Jiawei Zhang <br>  [[**Paper Link**]](http://arxiv.org/pdf/2304.11116v3)<details><summary>Read Abstract</summary>In this paper, we aim to develop a large language model (LLM) with the
...
**Advancing Medical Imaging with Language Models: A Journey from N-grams to ChatGPT**  2023 <br> Mingzhe Hu,  Shaoyan Pan,  Yuheng Li,  Xiaofeng Yang <br>  [[**Paper Link**]](http://arxiv.org/pdf/2304.04920v1)<details><summary>Read Abstract</summary>In this paper, we aimed to provide a review and tutorial for researchers in
...
**SAMM (Segment Any Medical Model): A 3D Slicer Integration to SAM**  2023 <br> Liu, Yihao,  Zhang, Jiaming,  She, Zhangcong,  Kheradmand, Amir,  Armand, Mehran <br>  [[**Paper Link**]](http://arxiv.org/pdf/2304.05622v3)<details><summary>Read Abstract</summary>The Segment Anything Model (SAM) is a new image segmentation tool trained
...
**Segment Everything Everywhere All at Once**  2023 <br> Zou, Xueyan,  Yang, Jianwei,  Zhang, Hao,  Li, Feng,  Li, Linjie,  Gao, Jianfeng,  Lee, Yong Jae <br>  [[**Paper Link**]](http://arxiv.org/pdf/2304.06718v4)<details><summary>Read Abstract</summary>In this work, we present SEEM, a promptable and interactive model for
...
**Visual Instruction Tuning**  2023 <br> Liu, Haotian,  Li, Chunyuan,  Wu, Qingyang,  Lee, Yong Jae <br>  [[**Paper Link**]](http://arxiv.org/pdf/2304.08485v1)<details><summary>Read Abstract</summary>Instruction tuning large language models (LLMs) using machine-generated
...
**MiniGPT-4: Enhancing Vision-Language Understanding with Advanced Large Language Models**  2023 <br> Zhu, Deyao,  Chen, Jun,  Shen, Xiaoqian,  Li, Xiang,  Elhoseiny, Mohamed <br>  [[**Paper Link**]](http://arxiv.org/pdf/2304.10592v1)<details><summary>Read Abstract</summary>The recent GPT-4 has demonstrated extraordinary multi-modal abilities, such
...
**Can GPT-4 Perform Neural Architecture Search?**  2023 <br> Mingkai Zheng,  Xiu Su,  Shan You,  Fei Wang,  Chen Qian,  Chang Xu,  Samuel Albanie <br>  [[**Paper Link**]](http://arxiv.org/pdf/2304.10970v3)<details><summary>Read Abstract</summary>We investigate the potential of GPT-4~\cite{gpt4} to perform Neural
...
**Evaluating ChatGPT's Information Extraction Capabilities: An Assessment of Performance, Explainability, Calibration, and Faithfulness**  2023 <br> Li, Bo,  Fang, Gexiang,  Yang, Yang,  Wang, Quansen,  Ye, Wei,  Zhao, Wen,  Zhang, Shikun <br>  [[**Paper Link**]](http://arxiv.org/pdf/2304.11633v1)<details><summary>Read Abstract</summary>The capability of Large Language Models (LLMs) like ChatGPT to comprehend
...
**Track Anything: Segment Anything Meets Videos**  2023 <br> Jinyu Yang,  Mingqi Gao,  Zhe Li,  Shang Gao,  Fangjing Wang,  Feng Zheng <br>  [[**Paper Link**]](http://arxiv.org/pdf/2304.11968v2)<details><summary>Read Abstract</summary>Recently, the Segment Anything Model (SAM) gains lots of attention rapidly
...
**Segment Anything in Medical Images**  2023 <br> Jun Ma,  Bo Wang <br>  [[**Paper Link**]](http://arxiv.org/pdf/2304.12306v2)<details><summary>Read Abstract</summary>Medical image segmentation is a critical component in clinical practice,
...
**Medical SAM Adapter: Adapting Segment Anything Model for Medical Image Segmentation**  2023 <br> Wu, Junde,  Fu, Rao,  Fang, Huihui,  Liu, Yuanpei,  Wang, Zhaowei,  Xu, Yanwu,  Jin, Yueming,  Arbel, Tal <br>  [[**Paper Link**]](http://arxiv.org/pdf/2304.12620v6)<details><summary>Read Abstract</summary>The Segment Anything Model (SAM) has recently gained popularity in the field
...
**Learnable Ophthalmology SAM**  2023 <br> Qiu, Zhongxi,  Hu, Yan,  Li, Heng,  Liu, Jiang <br>  [[**Paper Link**]](http://arxiv.org/pdf/2304.13425v1)<details><summary>Read Abstract</summary>Segmentation is vital for ophthalmology image analysis. But its various modal
...
**Transfer Visual Prompt Generator across LLMs**  2023 <br> Ao Zhang,  Hao Fei,  Yuan Yao,  Wei Ji,  Li Li,  Zhiyuan Liu,  Tat-Seng Chua <br>  [[**Paper Link**]](http://arxiv.org/pdf/2305.01278v1)<details><summary>Read Abstract</summary>While developing a new vision-language LLM (VL-LLM) by pre-training on
...
**Caption Anything: Interactive Image Description with Diverse Multimodal Controls**  2023 <br> Teng Wang,  Jinrui Zhang,  Junjie Fei,  Hao Zheng,  Yunlong Tang,  Zhe Li,  Mingqi Gao,  Shanshan Zhao <br>  [[**Paper Link**]](http://arxiv.org/pdf/2305.02677v3)<details><summary>Read Abstract</summary>Controllable image captioning is an emerging multimodal topic that aims to
...
**ImageBind: One Embedding Space To Bind Them All**  2023 <br> Rohit Girdhar,  Alaaeldin El-Nouby,  Zhuang Liu,  Mannat Singh,  Kalyan Vasudev Alwala,  Armand Joulin,  Ishan Misra <br>  [[**Paper Link**]](http://arxiv.org/pdf/2305.05665v2)<details><summary>Read Abstract</summary>We present ImageBind, an approach to learn a joint embedding across six
...
**Segment and Track Anything**  2023 <br> Cheng, Yangming,  Li, Liulei,  Xu, Yuanyou,  Li, Xiaodi,  Yang, Zongxin,  Wang, Wenguan,  Yang, Yi <br>  [[**Paper Link**]](http://arxiv.org/pdf/2305.06558v1)<details><summary>Read Abstract</summary>This report presents a framework called Segment And Track Anything (SAMTrack)
...
**An Inverse Scaling Law for CLIP Training**  2023 <br> Xianhang Li,  Zeyu Wang,  Cihang Xie <br>  [[**Paper Link**]](http://arxiv.org/pdf/2305.07017v1)<details><summary>Read Abstract</summary>CLIP, the first foundation model that connects images and text, has enabled
...
**Cream: Visually-Situated Natural Language Understanding with Contrastive Reading Model and Frozen Large Language Models**  2023 <br> Kim, Geewook,  Lee, Hodong,  Kim, Daehee,  Jung, Haeji,  Park, Sanghee,  Kim, Yoonsik,  Yun, Sangdoo,  Kil, Taeho,  Lee, Bado,  Park, Seunghyun <br>  [[**Paper Link**]](http://arxiv.org/pdf/2305.15080v1)<details><summary>Read Abstract</summary>Advances in Large Language Models (LLMs) have inspired a surge of research
...
**Voyager: An Open-Ended Embodied Agent with Large Language Models**  2023 <br> Wang, Guanzhi,  Xie, Yuqi,  Jiang, Yunfan,  Mandlekar, Ajay,  Xiao, Chaowei,  Zhu, Yuke,  Fan, Linxi,  Anandkumar, Anima <br>  [[**Paper Link**]](http://arxiv.org/pdf/2305.16291v1)<details><summary>Read Abstract</summary>We introduce Voyager, the first LLM-powered embodied lifelong learning agent
...
**DeSAM: Decoupling Segment Anything Model for Generalizable Medical Image Segmentation**  2023 <br> Gao, Yifan,  Xia, Wei,  Hu, Dingdu,  Gao, Xin <br>  [[**Paper Link**]](http://arxiv.org/pdf/2306.00499v1)<details><summary>Read Abstract</summary>Deep learning based automatic medical image segmentation models often suffer
...
**Video-ChatGPT: Towards Detailed Video Understanding via Large Vision and Language Models**  2023 <br> Muhammad Maaz,  Hanoona Rasheed,  Salman Khan,  Fahad Shahbaz Khan <br>  [[**Paper Link**]](http://arxiv.org/pdf/2306.05424v1)<details><summary>Read Abstract</summary>Conversation agents fueled by Large Language Models (LLMs) are providing a
...
**Valley: Video Assistant with Large Language model Enhanced abilitY**  2023 <br> Ruipu Luo,  Ziwang Zhao,  Min Yang,  Junwei Dong,  Minghui Qiu,  Pengcheng Lu,  Tao Wang,  Zhongyu Wei <br>  [[**Paper Link**]](http://arxiv.org/pdf/2306.07207v1)<details><summary>Read Abstract</summary>Recently, several multi-modal models have been developed for joint image and
...
**Image Captioners Are Scalable Vision Learners Too**  2023 <br> Tschannen, Michael,  Kumar, Manoj,  Steiner, Andreas,  Zhai, Xiaohua,  Houlsby, Neil,  Beyer, Lucas <br>  [[**Paper Link**]](http://arxiv.org/pdf/2306.07915v1)<details><summary>Read Abstract</summary>Contrastive pretraining on image-text pairs from the web is one of the most
...
**XrayGPT: Chest Radiographs Summarization using Medical Vision-Language Models**  2023 <br> Thawkar, Omkar,  Shaker, Abdelrahman,  Mullappilly, Sahal Shaji,  Cholakkal, Hisham,  Anwer, Rao Muhammad,  Khan, Salman,  Laaksonen, Jorma,  Khan, Fahad Shahbaz <br>  [[**Paper Link**]](http://arxiv.org/pdf/2306.07971v1)<details><summary>Read Abstract</summary>The latest breakthroughs in large vision-language models, such as Bard and
...
**ViP: A Differentially Private Foundation Model for Computer Vision**  2023 <br> Yaodong Yu,  Maziar Sanjabi,  Yi Ma,  Kamalika Chaudhuri,  Chuan Guo <br>  [[**Paper Link**]](http://arxiv.org/pdf/2306.08842v2)<details><summary>Read Abstract</summary>Artificial intelligence (AI) has seen a tremendous surge in capabilities
...
**COSA: Concatenated Sample Pretrained Vision-Language Foundation Model**  2023 <br> Sihan Chen,  Xingjian He,  Handong Li,  Xiaojie Jin,  Jiashi Feng,  Jing Liu <br>  [[**Paper Link**]](http://arxiv.org/pdf/2306.09085v1)<details><summary>Read Abstract</summary>Due to the limited scale and quality of video-text training corpus, most
...
**LVLM-eHub: A Comprehensive Evaluation Benchmark for Large Vision-Language Models**  2023 <br> Peng Xu,  Wenqi Shao,  Kaipeng Zhang,  Peng Gao,  Shuo Liu,  Meng Lei,  Fanqing Meng,  Siyuan Huang,  Yu Qiao,  Ping Luo <br>  [[**Paper Link**]](http://arxiv.org/pdf/2306.09265v1)<details><summary>Read Abstract</summary>Large Vision-Language Models (LVLMs) have recently played a dominant role in
...
**Segment Any Point Cloud Sequences by Distilling Vision Foundation Models**  2023 <br> Youquan Liu,  Lingdong Kong,  Jun Cen,  Runnan Chen,  Wenwei Zhang,  Liang Pan,  Kai Chen,  Ziwei Liu <br>  [[**Paper Link**]](http://arxiv.org/pdf/2306.09347v1)<details><summary>Read Abstract</summary>Recent advancements in vision foundation models (VFMs) have opened up new
...
**LVM-Med: Learning Large-Scale Self-Supervised Vision Models for Medical Imaging via Second-order Graph Matching**  2023 <br> Duy M. H. Nguyen,  Hoang Nguyen,  Nghiem T. Diep,  Tan N. Pham,  Tri Cao,  Binh T. Nguyen,  Paul Swoboda,  Nhat Ho,  Shadi Albarqouni,  Pengtao Xie,  Daniel Sonntag,  Mathias Niepert <br>  [[**Paper Link**]](http://arxiv.org/pdf/2306.11925v2)<details><summary>Read Abstract</summary>Obtaining large pre-trained models that can be fine-tuned to new tasks with
...
**Fast Segment Anything**  2023 <br> Xu Zhao,  Wenchao Ding,  Yongqi An,  Yinglong Du,  Tao Yu,  Min Li,  Ming Tang,  Jinqiao Wang <br>  [[**Paper Link**]](http://arxiv.org/pdf/2306.12156v1)<details><summary>Read Abstract</summary>The recently proposed segment anything model (SAM) has made a significant
...
**TaCA: Upgrading Your Visual Foundation Model with Task-agnostic Compatible Adapter**  2023 <br> Binjie Zhang,  Yixiao Ge,  Xuyuan Xu,  Ying Shan,  Mike Zheng Shou <br>  [[**Paper Link**]](http://arxiv.org/pdf/2306.12642v1)<details><summary>Read Abstract</summary>Visual foundation models like CLIP excel in learning feature representations
...
**How to Efficiently Adapt Large Segmentation Model(SAM) to Medical Images**  2023 <br> Xinrong Hu,  Xiaowei Xu,  Yiyu Shi <br>  [[**Paper Link**]](http://arxiv.org/pdf/2306.13731v1)<details><summary>Read Abstract</summary>The emerging scale segmentation model, Segment Anything (SAM), exhibits
...
**Faster Segment Anything: Towards Lightweight SAM for Mobile Applications**  2023 <br> Chaoning Zhang,  Dongshen Han,  Yu Qiao,  Jung Uk Kim,  Sung-Ho Bae,  Seungkyu Lee,  Choong Seon Hong <br>  [[**Paper Link**]](http://arxiv.org/pdf/2306.14289v2)<details><summary>Read Abstract</summary>Segment Anything Model (SAM) has attracted significant attention due to its
...
**MedLSAM: Localize and Segment Anything Model for 3D Medical Images**  2023 <br> Wenhui, Lei,  Xu, Wei,  Xiaofan, Zhang,  Kang, Li,  Shaoting Zhang <br>  [[**Paper Link**]](http://arxiv.org/pdf/2306.14752v2)<details><summary>Read Abstract</summary>The Segment Anything Model (SAM) has recently emerged as a groundbreaking
...
**Kosmos-2: Grounding Multimodal Large Language Models to the World**  2023 <br> Zhiliang Peng,  Wenhui Wang,  Li Dong,  Yaru Hao,  Shaohan Huang,  Shuming Ma,  Furu Wei <br>  [[**Paper Link**]](http://arxiv.org/pdf/2306.14824v3)<details><summary>Read Abstract</summary>We introduce Kosmos-2, a Multimodal Large Language Model (MLLM), enabling new
...
**ViNT: A Foundation Model for Visual Navigation**  2023 <br> Dhruv Shah,  Ajay Sridhar,  Nitish Dashora,  Kyle Stachowicz,  Kevin Black,  Noriaki Hirose,  Sergey Levine <br>  [[**Paper Link**]](http://arxiv.org/pdf/2306.14846v1)<details><summary>Read Abstract</summary>General-purpose pre-trained models ("foundation models") have enabled
...
**Stone Needle: A General Multimodal Large-scale Model Framework towards Healthcare**  2023 <br> Weihua Liu,  Yong Zuo <br>  [[**Paper Link**]](http://arxiv.org/pdf/2306.16034v1)<details><summary>Read Abstract</summary>In healthcare, multimodal data is prevalent and requires to be
...
**RSPrompter: Learning to Prompt for Remote Sensing Instance Segmentation based on Visual Foundation Model**  2023 <br> Keyan Chen,  Chenyang Liu,  Hao Chen,  Haotian Zhang,  Wenyuan Li,  Zhengxia Zou,  Zhenwei Shi <br>  [[**Paper Link**]](http://arxiv.org/pdf/2306.16269v1)<details><summary>Read Abstract</summary>Leveraging vast training data (SA-1B), the foundation Segment Anything Model
...
**Foundation Model for Endoscopy Video Analysis via Large-scale Self-supervised Pre-train**  2023 <br> Zhao Wang,  Chang Liu,  Shaoting Zhang,  Qi Dou <br>  [[**Paper Link**]](http://arxiv.org/pdf/2306.16741v1)<details><summary>Read Abstract</summary>Foundation models have exhibited remarkable success in various applications,
...
**RefSAM: Efficiently Adapting Segmenting Anything Model for Referring Video Object Segmentation**  2023 <br> Yonglin, Li,  Jing, Zhang,  Xiao, Teng,  Long, Lan <br>  [[**Paper Link**]](http://arxiv.org/pdf/2307.00997v1)<details><summary>Read Abstract</summary>The Segment Anything Model (SAM) has gained significant attention for its
...
**SAM-DA: UAV Tracks Anything at Night with SAM-Powered Domain Adaptation**  2023 <br> Liangliang, Yao,  Haobo, Zuo,  Guangze, Zheng,  Changhong, Fu,  Jia, Pan <br>  [[**Paper Link**]](http://arxiv.org/pdf/2307.01024v1)<details><summary>Read Abstract</summary>Domain adaptation (DA) has demonstrated significant promise for real-time
...
**Segment Anything Meets Point Tracking**  2023 <br> Rajič, Frano,  Ke, Lei,  Tai, Yu-Wing,  Tang, Chi-Keung,  Danelljan, Martin,  Yu, Fisher <br>  [[**Paper Link**]](http://arxiv.org/pdf/2307.01197v1)<details><summary>Read Abstract</summary>The Segment Anything Model (SAM) has established itself as a powerful
...
**BuboGPT: Enabling Visual Grounding in Multi-Modal LLMs**  2023 <br> Zhao, Yang,  Lin, Zhijie,  Zhou, Daquan,  Huang, Zilong,  Feng, Jiashi,  Kang, Bingyi <br>  [[**Paper Link**]](http://arxiv.org/pdf/2307.08581v1)<details><summary>Read Abstract</summary>LLMs have demonstrated remarkable abilities at interacting with humans
